...
class ADT
{
	...
	/* searchDirectiveTable     : 
									...
									INPUT  		- currToken : String, the token which is to be searched in assembler directive table.
	...
	*/
	...
	/* performDirectiveFunction : 
									OBJECTIVE 	- Stores variables and segment names into segment table after checking directive type and update location counter accordingly.
									INPUTS  	-
	...
	*/
	static int performDirectiveFunction(String directive, String symName, ArrayList<String> nextTokens)
	{
		...
		switch (directive)
		{
			...
			case "DD"		:
								/*
									If directive is DB, DW, or DD, then add the variable to symbol table and update location counter as follows:
										DB - +1
										DW - +2
										DD - +4
								*/
